...
;// CONCATENATED MODULE: external "enc-utils"
const external_enc_utils_namespaceObject = require("enc-utils");
;// CONCATENATED MODULE: external "ethereum-cryptography/hdkey"
const hdkey_namespaceObject = require("ethereum-cryptography/hdkey");
;// CONCATENATED MODULE: external "hash.js"
...
;// CONCATENATED MODULE: ./src/constant_points.ts
...
;// CONCATENATED MODULE: ./src/signature.ts
/// //////////////////////////////////////////////////////////////////////////////
...
function assertInRange(input, lowerBound, upperBound) {
  let inputName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "";
...
function hashMsg(instructionTypeBn, vault0Bn, vault1Bn, amount0Bn, amount1Bn, nonceBn, expirationTimestampBn, token0, token1OrPubKey) {
  let condition = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : null;
...
*/
function getTransferMsgHash(amount, nonce, senderVaultId, token, receiverVaultId, receiverPublicKey, expirationTimestamp) {
  let condition = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : null;
...
const ec = starkEc;
;// CONCATENATED MODULE: ./src/key_derivation.ts
/// //////////////////////////////////////////////////////////////////////////////
// Copyright 2019 StarkWare Industries Ltd.                                    //
//                                                                             //
// Licensed under the Apache License, Version 2.0 (the "License").             //
...
/******/ })()
;
//# sourceMappingURL=starkwareCrypto.cjs.js.map