...
async function main() {
  ...
  const compiledSierra = json.parse(
    fs
      .readFileSync("target/dev/Testing_UpgradeableContract_V1.sierra.json")
      .toString("ascii")
  );
  const compiledCasm = json.parse(
    fs
      .readFileSync("target/dev/Testing_UpgradeableContract_V1.casm.json")
      .toString("ascii")
  );
  ...
  // const contractClassHash = '0x4b4039a96b054f4311a34ecf61c5ae776725633b7876e81793ad55b31754f18';
  const contractClassHash = deployResponse.class_hash;
  console.log("✅ Test Contract declared with classHash =", contractClassHash);
  // const contractClassHash = 0x5c5ae18d94c3fc38db36489f172a19ee19004ef90a93b865b1225d5990dc915
